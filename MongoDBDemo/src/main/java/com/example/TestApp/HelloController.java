	...
	MongoClient client = new MongoClient("localhost", 27017);
		...
		*/
		...
		for(Document dc:docList) {
			...
			BasicDBObject searchQuery = new BasicDBObject().append("_id",dc.get("_id"));
			...
			System.out.println("object"+coll.find(new Document("_id",dc.get("_id"))));
			System.out.println(new Document("_id",dc.get("_id")));
			System.out.println("seconddddd"+dc);
			newDocument.put("scores", tempList);
